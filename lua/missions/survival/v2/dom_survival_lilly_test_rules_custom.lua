return function()
	...
	if  waveStrength == "easy" then
		rules = require("lua/missions/survival/v2/dom_survival_lilly_test_rules_easy.lua")()	
	elseif waveStrength == "normal" then
		rules = require("lua/missions/survival/v2/dom_survival_lilly_test_rules_normal.lua")()		
	elseif waveStrength == "hard" then
		rules = require("lua/missions/survival/v2/dom_survival_lilly_test_rules_hard.lua")()	
	elseif waveStrength == "brutal" then
		rules = require("lua/missions/survival/v2/dom_survival_lilly_test_rules_brutal.lua")()	
	else
		rules = require("lua/missions/survival/v2/dom_survival_lilly_test_rules_default.lua")()		
	end
