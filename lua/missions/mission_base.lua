...
function mission_base:SelectPlayerSpawnpointNearPosition(spawnPoints)
	LogService:Log("mission_base.SelectPlayerSpawnpointNearPosition");
...
function mission_base:SelectPlayerSpawnpointForObjectiveTile(spawnPoints)
	LogService:Log("mission_base.SelectPlayerSpawnpointForObjectiveTile");
    local objectiveTile = self.data:GetStringOrDefault("objective_tile", "");
    if IsNullOrEmpty(objectiveTile) then
        return INVALID_ID
    end
    LogService:Log("mission_base:SelectPlayerSpawnpointForObjectiveTile objectiveTile : " .. tostring(objectiveTile))
    ...
    LogService:Log("mission_base:SelectPlayerSpawnpointForObjectiveTile objectiveMinDistance : " .. tostring(objectiveMinDistance))
	LogService:Log("mission_base:SelectPlayerSpawnpointForObjectiveTile objectiveMaxDistance : " .. tostring(objectiveMaxDistance))
	...
	LogService:Log("mission_base:SelectPlayerSpawnpointForObjectiveTile #tilePositions : " .. tostring(#tilePositions))
    ...
    for spawnPoint in Iter( spawnPoints ) do
		...
		LogService:Log("mission_base:SelectPlayerSpawnpointForObjectiveTile spawnPos : " .. tostring(spawnPos.x) .. "," .. tostring(spawnPos.y) .. "," .. tostring(spawnPos.z))

        local minDistance = 10000000000000.0
        for tileCenter in Iter( tilePositions ) do
			LogService:Log("mission_base:SelectPlayerSpawnpointForObjectiveTile tileCenter : " .. tostring(tileCenter.x) .. "," .. tostring(tileCenter.y) .. "," .. tostring(tileCenter.z))
            local distance = Distance( spawnPos, tileCenter )
			LogService:Log("mission_base:SelectPlayerSpawnpointForObjectiveTile distance : " .. tostring(distance) .. " , " .. tostring(farthestSpawn.distance))
	...
	LogService:Log("mission_base:SelectPlayerSpawnpointForObjectiveTile farthestSpawn.distance : " .. tostring(farthestSpawn.distance))
    return farthestSpawn.entity;
end

-- 2
function mission_base:SelectPlayerSpawnPoint()
	LogService:Log("mission_base.SelectPlayerSpawnPoint");
	...
	LogService:Log("mission_base.SelectSpawnPoint");
